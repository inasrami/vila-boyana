...
const roomImages = [
    new URL('../assets/staq1.jpg', import.meta.url).href,
    new URL('../assets/staq2.jpg', import.meta.url).href,
    new URL('../assets/staq3.jpg', import.meta.url).href,
    new URL('../assets/staq4.jpg', import.meta.url).href,
    new URL('../assets/staq5.jpg', import.meta.url).href,
    new URL('../assets/staq6.jpg', import.meta.url).href,
    new URL('../assets/staq7.jpg', import.meta.url).href,
    new URL('../assets/staq8.jpg', import.meta.url).href,
    new URL('../assets/staq9.jpg', import.meta.url).href,
    new URL('../assets/staq10.jpg', import.meta.url).href,
]

const hotelImages = [
    new URL('../assets/hotel1.jpg', import.meta.url).href,
    new URL('../assets/hotel2.jpg', import.meta.url).href,
    new URL('../assets/hotel3.jpg', import.meta.url).href,
    new URL('../assets/hotel4.jpg', import.meta.url).href,
    new URL('../assets/hotel5.jpg', import.meta.url).href,
    new URL('../assets/hotel6.jpg', import.meta.url).href,
    new URL('../assets/hotel7.jpg', import.meta.url).href,
    new URL('../assets/hotel8.jpg', import.meta.url).href,
    new URL('../assets/hotel9.jpg', import.meta.url).href,
    new URL('../assets/hotel10.jpg', import.meta.url).href,
    new URL('../assets/hotel11.jpg', import.meta.url).href,
    new URL('../assets/hotel12.jpg', import.meta.url).href,
    new URL('../assets/hotel13.jpg', import.meta.url).href,
    new URL('../assets/hotel14.jpg', import.meta.url).href,
    new URL('../assets/hotel15.jpg', import.meta.url).href,
]
